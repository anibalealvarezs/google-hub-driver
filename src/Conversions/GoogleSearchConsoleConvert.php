    ...
    public static function metrics(
        ...
        foreach ($rows as $row) {
            ...
            $groupKey = KeyGenerator::generateMetricConfigKey(
                ...
                name: 'impressions',
                period: $periodValue,
                page: \Helpers\AssetsPatternsHelpers\PagePatternsHelper::getCanonicalId('google_search_console', null, $pageUrl ?? $siteUrl),
        ...
        foreach ($aggregatedData as $groupKey => $data) {
            ...
            $rowMetrics = UniversalMetricConverter::convert([$data['metrics']], [
                ...
                'context' => UniversalMetricConverter::getUniversalContext([
                    ...
                    'page' => \Helpers\AssetsPatternsHelpers\PagePatternsHelper::getCanonicalId('google_search_console', null, $pageUrl ?? $siteUrl),
                    'pagePlatformId' => \Helpers\AssetsPatternsHelpers\PagePatternsHelper::getPlatformId('google_search_console', null, is_object($page) && method_exists($page, 'getPlatformId') ? (string) $page->getPlatformId() : (string) $page),
